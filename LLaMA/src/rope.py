...
LLaMA removes absolute position embeddings and uses RoPE at every layer
(LLaMA paper, Section 2.2, "Rotary Embeddings [RoPE]"; Su et al. 2021). RoPE
rotates the query and key vectors by an angle proportional to their absolute
position; because attention depends on the *difference* of rotations, the
mechanism is effectively relative.

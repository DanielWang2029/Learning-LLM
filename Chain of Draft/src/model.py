...
Chain of Draft is a *prompting* result, not an architecture change, so we use one
small, standard causal LM and only vary how the solution is *written* (Standard /
CoT / CoD). The same weights answer all three styles.
"""
